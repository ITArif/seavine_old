            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="contact_person" id="" value="{{old('contact_person')}}" class="form-control" placeholder="Contact Person">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="remark" id="" value="{{old('remark')}}" class="form-control" placeholder="Remark">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="purpose" id="" value="{{old('purpose')}}" class="form-control" placeholder="Purpose">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="requisition_date" id="" value="{{old('requisition_date')}}" class="form-control">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    <label>Is Confirmed ?<span style="color: red;">*</span></label><br>
