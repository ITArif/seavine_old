          ...
          <div class="lik-uftcl-pdf-body">
            ...
            <div style="width:900px">
              <div style="width:48%; float:right; margin:5px">
                    <table class="">
                      ...
                      <tbody>
                        ...
                        <tr>
                        <td> Balance C/D </td>
                        <td style="text-align:right;">{{ $total_income - $total_expen }}</td>
                        </tr>
                      </tbody>
                 ...
                 <div style="width:48%; float:left;margin:5px">
                    <table class="">
                      ...
                      @endforeach 
                        <tr>
                          @if ( ($total_income - ( $total_expen - $total_profit_head)) > 0 )
                            <td> Net Profit </td>
                            <td style="text-align:right;"><u><?php echo $total_income - ( $total_expen - $total_profit_head); ?></u></td>
                          @else
                            <td> Net Loss </td>
                            <td style="text-align:right;"><u><?php echo $total_income - ( $total_expen - $total_profit_head); ?></u></td>
                          @endif
              ...
              <div style="width:48%;float:left;margin-left:8px">
                <p class="ptf-ln-3" style="width:55%; margin-top:10px!important;"><b>  Total</b></p>
                <p style=""><u>{{ $total_income - $total_expen }}</u></p>
              </div>
